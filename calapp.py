...
text_result.grid(columnspan=5, padx=2, pady=2)
...
btn_plus.grid(row=2, column=4, padx=2, pady=2)
btn_minus = tk.Button(root, text="-", command=lambda: add_to_calculation("-"), width=5, font=("Arial", 14))
btn_minus.grid(row=3, column=4, padx=2, pady=2)
...
btn_clear.grid(row=6, column=1, columnspan=2, padx=2, pady=2)
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=11, font=("Arial", 14))
btn_equals.grid(row=6, column=3, columnspan=2, padx=2, pady=2)
